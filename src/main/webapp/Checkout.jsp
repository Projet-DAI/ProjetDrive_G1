					...
					<div class="col-xs-12 col-sm-7">
            			...
            			<form action="ConfirmCommand.jsp" method="post" id="commandeForm">
							...
							<form action="ChoixCreneauServlet" method="post">
							    <select name="creneau">
								    <!-- Utilisez une boucle pour afficher chaque cr�neau disponible -->
 							  ...
 							  <input type="submit" value="Choisir">							    
								...
								<script>
								    document.addEventListener("DOMContentLoaded", function() {
								        // S�lectionnez l'�l�ment HTML o� afficher le cr�neau choisi
								        var creneauChoisiText = document.getElementById("creneauChoisiText");
								        
								        // S�lectionnez le menu d�roulant
								        var selectCreneau = document.querySelector("selectCreneau");
								        
								        // �coutez les changements de s�lection dans le menu d�roulant
								        selectCreneau.addEventListener("change", function() {
								            // R�cup�rez la valeur s�lectionn�e dans le menu d�roulant
								            var selectedCreneau = this.value;
								            
								            // Mettez � jour le texte avec le cr�neau choisi
								            creneauChoisiText.textContent = "Le cr�neau choisi est : " + selectedCreneau;
								        });
								    });
								</script>
	            ...
	            <div class="row">
	                ...
	                <div class="col-md-3">
	                    ...
	                    <ul>
	                        ...
	                        <li>
	                            <a href="javascript:void(0)">Comment �a fonctionne</a>
	                        </li>
	                        <li>
