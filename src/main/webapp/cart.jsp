    ...
    <section id="cart">
        <div class="container">
            <div class="row">
                ...
                <div class="col">
                    <a href="<c:url value='shop.html' />" class="btn btn-default">Continue Shopping</a>
                </div>
                <div class="col text-right">
                    ...
                    <h6 class="mt-3"><fmt:message key="total.amount" />: Rp 180.000</h6>
                    <a href="<c:url value='checkout.html' />" class="btn btn-lg btn-primary">Checkout <i class="fa fa-long-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </section>
