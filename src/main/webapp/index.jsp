					...
					<div class="shop-categories owl-carousel mt-5">
						<div class="item">
							<a href="shop.html">
								<div
									...
									<span class="d-flex mr-2"><i class="sb-bistro-carrot"></i><i
										class="sb-bistro-apple"></i></span>
						...
						<div class="item">
							<a href="shop.html">
								<div
									class="media d-flex align-items-center justify-content-center">
									<span class="d-flex mr-2"><i class="sb-bistro-roast-leg"></i><i
										class="sb-bistro-fish-1"></i></span>
									<div class="media-body">
