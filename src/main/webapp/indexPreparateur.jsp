            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarcollapse">
                    ...
                    <ul class="navbar-nav ml-auto">
                    	...
                    	<li class="nav-item" data-toggle="modal" data-target="#locationModal">Drive</li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="avatar-header"><img src="assets/img/profil.png"></div> Mon profil
                            </a>
            ...
            <div class="jumbotron jumbotron-video text-center bg-dark mb-0 rounded-0">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 mt-5 text-center">
                        <a href="preparerCommande.jsp" class="btn btn-primary btn-lg">Preparer Commandes</a>
                    </div>
                </div>
            </div>
        </section>
