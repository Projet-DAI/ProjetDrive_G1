					...
					%>
						<div class="item">
					        <div class="card card-product">
					            ...
					            <div class="card-body">
					                <a href="servletCentral?method=ajouterList&produitId=<%= produit.getIdProduit() %>">
					                ...
					                <a href="ServletPanier?method=ajouterPanier&produitId=<%= produit.getIdProduit() %>" class="btn btn-block btn-primary">
					                    Ajouter au panier
					                </a>
					            </div>
					        </div>
